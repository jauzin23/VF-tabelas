...
from .dados_next import percorrer_paginacao, extrair_dados_next
from .tipos import Paginacao
from .utilitarios_url import (
    PARAMETROS_PAGINACAO, construir_url_paginada, normalizar_url,
    parametro_pagina_de_url,
)
